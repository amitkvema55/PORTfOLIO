...
function Home() {
  return (
    ...
    <a href="https://drive.google.com/file/d/1o-Hnjm562v0CNurokcFnUyvR-lrINUdb/view?usp=sharing" target="blank" className='bg-blue-500 px-3 py-2 rounded-lg text-2xl text-white'>DownLoad CV</a>
